...
<head>
    ...
    {{-- icon  --}}
    <script src="https://kit.fontawesome.com/9ab8981530.js" crossorigin="anonymous"></script>

    <!-- add icon link -->
    <link rel = "icon" href ="{{ asset('assets/img/logo_title.svg') }}" type = "image/png">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
                <div class="sidebar-brand-icon">
                    <img class="img-fluid" src="{{ asset('assets/img/logo_telyuecommerce.svg') }}" alt="logo">
                </div>
            </a>
            ...
            <li class="nav-item 
            @if (request()->is('admin/merchandise*'))
                    active
            @endif">
