...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Order Selesai</h1>
    </div>

    <!-- Content Row -->

    <!-- Modal Edit Kategori -->
    <div class="modal fade text-left" id="detailOrderSelesai" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Order Selesai</h6>
        </div>
        <div class="card-body">
